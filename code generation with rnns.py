...
model_w2v, input_dict_w2v = code_predict_w2v.makeModelAndInput(50, corpus_sen_w2v, window=5, allowStopWords=True)
...
models = rnns()
model = models.make_many_one_model(serial_input_card=6,architecture_per_ss=[('inpk',50),('jnk', 100),('ffk', 60),('ffk', 50)], activation="linear", hidden_activations="relu")
